        ...
        <form className="space-y-6">
          ...
          <section className="grid grid-cols-1 lg:grid-cols-2 gap-x-8 gap-y-4">
            ...
            <div className="form-group">
              <input id="nombre" type="text" placeholder="Ingrese el nombre" className="form-input"/>
              <label htmlFor="nombre" className="form-label">Nombre</label>
            </div>

            <div className="form-group">
              <input id="apellido" type="text" placeholder="Ingrese el apellido" className="form-input"/>
              <label htmlFor="apellido" className="form-label">Apellido</label>
            </div>

            <div className="form-group">
              <input id="cedula" type="text" placeholder="Ej: V-12345678" className="form-input"/>
              <label htmlFor="cedula" className="form-label">Cédula</label>
            </div>

            <div className="form-group">
              <input id="correo" type="email" placeholder="correo@ejemplo.com" className="form-input"/>
              <label htmlFor="correo" className="form-label">Correo</label>
            </div>

            <div className="form-group">
              <input id="fecha-nacimiento" type="date" className="form-input"/>
            ...
            <div className="form-group">
              <input id="telefono" type="text" placeholder="0412-1234567" className="form-input"/>
              <label htmlFor="telefono" className="form-label">Teléfono</label>
            </div>

            <div>
              <label className="block text-sm font-medium mb-1">Foto de perfil</label>
              <input type="file" className="w-full rounded-lg border border-gray-300 px-3 py-2"/>
            </div>
          </section>
